...
CMD ["sh", "-c", "streamlit run Simulacion/dataset_generador_v52_0.py --server.port=8501 --server.address=0.0.0.0 & streamlit run Dashboard/app.py --server.port=8502 --server.address=0.0.0.0"]
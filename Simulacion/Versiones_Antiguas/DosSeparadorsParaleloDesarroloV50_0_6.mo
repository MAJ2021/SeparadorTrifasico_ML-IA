model DosSeparadorsParaleloDesarroloV50_0_6
  ...
  parameter Real beta = 0.0;   // refuerzo proporcional desactivado
  parameter Real gamma = 0.0;  // refuerzo cuadrático desactivado
...
equation
  ...
  // Descarga sin refuerzos adicionales
...
end DosSeparadorsParaleloDesarroloV50_0_6;

model DosSeparadorsParaleloDesarroloV49_14
  ...
  Modelica.Blocks.Continuous.PI pidSep1Petroleo(k=1.2, T=900);
  Modelica.Blocks.Continuous.PI pidSep2General(k=0.9, T=1600);
  Modelica.Blocks.Continuous.PI pidSep2Petroleo(k=1.2, T=900);
...
end DosSeparadorsParaleloDesarroloV49_14;

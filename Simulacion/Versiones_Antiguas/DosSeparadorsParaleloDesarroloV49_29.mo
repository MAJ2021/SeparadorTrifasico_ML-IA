model DosSeparadorsParaleloDesarroloV49_29
  ...
  // Controladores PI (tiempos ultracortos)
  Modelica.Blocks.Continuous.PI pidSep1General(k=4.0, T=25);
  Modelica.Blocks.Continuous.PI pidSep1Petroleo(k=4.5, T=25);
  Modelica.Blocks.Continuous.PI pidSep2General(k=4.0, T=25);
  Modelica.Blocks.Continuous.PI pidSep2Petroleo(k=4.5, T=25);
...
end DosSeparadorsParaleloDesarroloV49_29;

model DosSeparadorsParaleloDesarroloV49_8
  ...
  Modelica.Blocks.Continuous.PI pidSep1General(k=0.8, T=1800);
  Modelica.Blocks.Continuous.PI pidSep2Petroleo(k=0.8, T=1800);
...
end DosSeparadorsParaleloDesarroloV49_8;

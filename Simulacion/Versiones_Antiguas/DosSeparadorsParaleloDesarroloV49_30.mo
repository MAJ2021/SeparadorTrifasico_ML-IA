model DosSeparadorsParaleloDesarroloV49_30
  ...
  Modelica.Blocks.Continuous.PI pidSep1General(k=3.0, T=100);
  Modelica.Blocks.Continuous.PI pidSep1Petroleo(k=3.5, T=100);
  Modelica.Blocks.Continuous.PI pidSep2General(k=3.0, T=100);
  Modelica.Blocks.Continuous.PI pidSep2Petroleo(k=3.5, T=100);
...
equation
  ...
  sep1.Q_out_agua     = min(sep1.Q_in_agua, sep1.Q_in_agua * (1 + pidSep1General.y/100));
  sep1.Q_out_petroleo = min(sep1.Q_in_petroleo, sep1.Q_in_petroleo * (1 + pidSep1Petroleo.y/100));

  sep2.Q_out_agua     = min(sep2.Q_in_agua, sep2.Q_in_agua * (1 + pidSep2General.y/100));
  sep2.Q_out_petroleo = min(sep2.Q_in_petroleo, sep2.Q_in_petroleo * (1 + pidSep2Petroleo.y/100));

end DosSeparadorsParaleloDesarroloV49_30;

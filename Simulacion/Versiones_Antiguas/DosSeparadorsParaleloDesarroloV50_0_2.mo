model DosSeparadorsParaleloDesarroloV50_0_2
  ...
  // Controladores PID (ajustados para convergencia <1800s y estabilidad en 54%)
  Modelica.Blocks.Continuous.PID pidSep1General(
    k=2.0, Ti=60, Td=12, y_start=0);
  Modelica.Blocks.Continuous.PID pidSep1Petroleo(
    k=5.0, Ti=15, Td=6, y_start=0);
  ...
  parameter Real gamma = 0.05;   // refuerzo cuadrático reducido para petróleo
...
end DosSeparadorsParaleloDesarroloV50_0_2;

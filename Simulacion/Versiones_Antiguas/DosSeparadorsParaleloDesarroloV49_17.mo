model DosSeparadorsParaleloDesarroloV49_17
  ...
  Modelica.Blocks.Continuous.PI pidSep1Petroleo(k=1.2, T=800);
  Modelica.Blocks.Continuous.PI pidSep2General(k=1.5, T=600);
  Modelica.Blocks.Continuous.PI pidSep2Petroleo(k=1.2, T=800);
  ...
  model Separador
    ...
    Real nivelAgua(start=0.21);       // ~21% agua
    Real nivelPetroleo(start=0.54);   // ~54% petróleo
    Real nivelGeneral;
    Real nivelAgua_pct;
...
end DosSeparadorsParaleloDesarroloV49_17;

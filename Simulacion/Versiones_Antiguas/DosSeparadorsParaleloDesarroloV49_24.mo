model DosSeparadorsParaleloDesarroloV49_24
  ...
  // Controladores PI (solo acortamos tiempos)
  Modelica.Blocks.Continuous.PI pidSep1General(k=2.5, T=450);
  Modelica.Blocks.Continuous.PI pidSep1Petroleo(k=2.0, T=450);
  Modelica.Blocks.Continuous.PI pidSep2General(k=2.5, T=450);
  Modelica.Blocks.Continuous.PI pidSep2Petroleo(k=2.0, T=450);
...
end DosSeparadorsParaleloDesarroloV49_24;

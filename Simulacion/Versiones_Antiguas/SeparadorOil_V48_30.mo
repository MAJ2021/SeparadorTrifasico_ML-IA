model SeparadorOil_V48_30
  ...
  // Ajuste PI más agresivo
  parameter Real Kp = 0.005;                  // proporcional más fuerte
  parameter Real Ki = 5e-5;                   // integral más rápido

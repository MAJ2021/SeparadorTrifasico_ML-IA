model DosSeparadorsParaleloDesarroloV49_28_14
  ...
  Modelica.Blocks.Continuous.PI pidSep1Petroleo(k=1.8, T=90);
  Modelica.Blocks.Continuous.PI pidSep2General(k=1.0, T=180);
  Modelica.Blocks.Continuous.PI pidSep2Petroleo(k=1.8, T=90);

  // Coeficientes
  parameter Real Kv_agua = 3.5;
  parameter Real Kv_petroleo = 4.0;
...
end DosSeparadorsParaleloDesarroloV49_28_14;

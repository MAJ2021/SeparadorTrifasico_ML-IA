model DosSeparadorsParaleloDesarroloV49_19
  parameter Real V_sep = 17;
  parameter Real Q_agua = 83;
  parameter Real Q_petroleo = 20;
  parameter Real Q_liquidos = Q_agua + Q_petroleo;

  // Setpoints correctos de planta
  parameter Real SP_general  = 75 "Setpoint nivel general (%)";
  parameter Real SP_petroleo = 54 "Setpoint nivel petróleo (%)";

  // Controladores PI (ajustados para ~1800 s)
  Modelica.Blocks.Continuous.PI pidSep1General(k=1.2, T=1600);
  Modelica.Blocks.Continuous.PI pidSep1Petroleo(k=1.0, T=1600);
  Modelica.Blocks.Continuous.PI pidSep2General(k=1.2, T=1600);
  Modelica.Blocks.Continuous.PI pidSep2Petroleo(k=1.0, T=1600);
...
end DosSeparadorsParaleloDesarroloV49_19;

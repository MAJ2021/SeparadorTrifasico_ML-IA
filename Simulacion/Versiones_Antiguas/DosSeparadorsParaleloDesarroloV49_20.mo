model DosSeparadorsParaleloDesarroloV49_20
  ...
  // Controladores PI (más agresivos)
  Modelica.Blocks.Continuous.PI pidSep1General(k=2.0, T=600);
  Modelica.Blocks.Continuous.PI pidSep1Petroleo(k=1.5, T=800);
  Modelica.Blocks.Continuous.PI pidSep2General(k=2.0, T=600);
  Modelica.Blocks.Continuous.PI pidSep2Petroleo(k=1.5, T=800);
...
end DosSeparadorsParaleloDesarroloV49_20;

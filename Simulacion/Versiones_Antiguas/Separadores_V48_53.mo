model Separadores_V48_53
  ...
  // Estados dinámicos
  Real V_agua1(start=0), V_oil1(start=0), Pgas1(start=3.5e5);
  Real V_agua2(start=0), V_oil2(start=0), Pgas2(start=3.5e5);
...
equation
  ...
  Qout_total1 = apertura_total1*sqrt(Pgas1/1e5)*0.02;
  Qout_oil1   = apertura_oil1*sqrt(Pgas1/1e5)*0.005;
  ...
  Qout_total2 = apertura_total2*sqrt(Pgas2/1e5)*0.02;
  Qout_oil2   = apertura_oil2*sqrt(Pgas2/1e5)*0.005;
  Qout_gas2   = max((Pgas2-1e5)/1e5*0.05,0);
end Separadores_V48_53;

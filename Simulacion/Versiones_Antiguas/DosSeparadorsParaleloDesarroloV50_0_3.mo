model DosSeparadorsParaleloDesarroloV50_0_3
  ...
  Modelica.Blocks.Continuous.PID pidSep1General(
    k=1.8, Ti=80, Td=10, y_start=0);
  Modelica.Blocks.Continuous.PID pidSep1Petroleo(
    k=3.5, Ti=25, Td=6, y_start=0);
  ...
  parameter Real beta = 0.5;   // refuerzo proporcional suavizado
  parameter Real gamma = 0.03; // refuerzo cuadrático reducido para petróleo
...
end DosSeparadorsParaleloDesarroloV50_0_3;

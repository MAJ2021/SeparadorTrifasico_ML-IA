model DosSeparadorsParaleloDesarroloV49_33
  ...
  // Controladores PI (muy agresivos)
  Modelica.Blocks.Continuous.PI pidSep1General(k=5.0, T=15);
  Modelica.Blocks.Continuous.PI pidSep1Petroleo(k=6.0, T=15);
  Modelica.Blocks.Continuous.PI pidSep2General(k=5.0, T=15);
  Modelica.Blocks.Continuous.PI pidSep2Petroleo(k=6.0, T=15);
...
end DosSeparadorsParaleloDesarroloV49_33;

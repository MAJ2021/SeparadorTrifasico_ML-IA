within ;
model DosSeparadoresTrifasicosRealistaPerturbaciones_V6_24h
  ...
  // Perturbaciones distribuidas en 24h
  Modelica.Blocks.Sources.Step perturbWater(height=Qin_water_total*0.2, startTime=21600);   // 6h
  Modelica.Blocks.Sources.Step perturbOil(height=Qin_oil_total*0.15, startTime=43200);     // 12h
  Modelica.Blocks.Sources.Step perturbGas(height=Qin_gas_total*0.2, startTime=64800);      // 18h
  Modelica.Blocks.Sources.Step perturbPressure(height=0.1*P_sep, startTime=79200);         // 22h
...
end DosSeparadoresTrifasicosRealistaPerturbaciones_V6_24h;

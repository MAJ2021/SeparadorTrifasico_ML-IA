model DosSeparadorsParaleloDesarroloV49_34
  ...
  // Controladores PI (balanceados)
  Modelica.Blocks.Continuous.PI pidSep1General(k=2.0, T=200);
  Modelica.Blocks.Continuous.PI pidSep1Petroleo(k=2.5, T=200);
  Modelica.Blocks.Continuous.PI pidSep2General(k=2.0, T=200);
  Modelica.Blocks.Continuous.PI pidSep2Petroleo(k=2.5, T=200);
...
end DosSeparadorsParaleloDesarroloV49_34;

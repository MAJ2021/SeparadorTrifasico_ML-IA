model DosSeparadorsParaleloDesarroloV49_15
  ...
  Modelica.Blocks.Continuous.PI pidSep1Petroleo(k=1.0, T=800);
  Modelica.Blocks.Continuous.PI pidSep2General(k=0.9, T=1600);
  Modelica.Blocks.Continuous.PI pidSep2Petroleo(k=1.0, T=800);
...
end DosSeparadorsParaleloDesarroloV49_15;

model DosSeparadorsParaleloDesarroloV49_25
  ...
  // Controladores PI (más agresivos para petróleo)
  Modelica.Blocks.Continuous.PI pidSep1General(k=2.5, T=400);
  Modelica.Blocks.Continuous.PI pidSep1Petroleo(k=3.0, T=300);
  Modelica.Blocks.Continuous.PI pidSep2General(k=2.5, T=400);
  Modelica.Blocks.Continuous.PI pidSep2Petroleo(k=3.0, T=300);
...
end DosSeparadorsParaleloDesarroloV49_25;

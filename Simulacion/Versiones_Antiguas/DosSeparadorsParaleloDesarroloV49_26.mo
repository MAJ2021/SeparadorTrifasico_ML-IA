model DosSeparadorsParaleloDesarroloV49_26
  ...
  // Controladores PI (tiempos mucho más cortos)
  Modelica.Blocks.Continuous.PI pidSep1General(k=2.5, T=200);
  Modelica.Blocks.Continuous.PI pidSep1Petroleo(k=3.0, T=200);
  Modelica.Blocks.Continuous.PI pidSep2General(k=2.5, T=200);
  Modelica.Blocks.Continuous.PI pidSep2Petroleo(k=3.0, T=200);
...
end DosSeparadorsParaleloDesarroloV49_26;

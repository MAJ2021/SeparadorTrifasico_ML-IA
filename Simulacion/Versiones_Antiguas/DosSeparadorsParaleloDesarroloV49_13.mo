model DosSeparadorsParaleloDesarroloV49_13
  ...
  Modelica.Blocks.Continuous.PI pidSep1Petroleo(k=0.5, T=2000);
  Modelica.Blocks.Continuous.PI pidSep2General(k=0.9, T=1600);
  Modelica.Blocks.Continuous.PI pidSep2Petroleo(k=0.5, T=2000);
...
end DosSeparadorsParaleloDesarroloV49_13;

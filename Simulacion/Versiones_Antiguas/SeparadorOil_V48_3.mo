model SeparadorOil_V48_3
  ...
  parameter Real Kp = 0.02;   // ganancia proporcional razonable
  parameter Real Ki = 1e-5;   // ganancia integral pequeña
...
equation
  ...
  // Restricciones físicas: volumen entre 0 y V_sep
  when V_oil < 0 then
    reinit(V_oil, 0);
  end when;

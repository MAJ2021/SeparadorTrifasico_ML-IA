model DosSeparadorsParaleloDesarroloV49_28_1
  ...
  // Controladores PI (todavía agresivos, se ajustarán en .3)
  Modelica.Blocks.Continuous.PI pidSep1General(k=4.0, T=50);
  Modelica.Blocks.Continuous.PI pidSep1Petroleo(k=4.0, T=50);
  Modelica.Blocks.Continuous.PI pidSep2General(k=4.0, T=50);
  Modelica.Blocks.Continuous.PI pidSep2Petroleo(k=4.0, T=50);
...
end DosSeparadorsParaleloDesarroloV49_28_1;

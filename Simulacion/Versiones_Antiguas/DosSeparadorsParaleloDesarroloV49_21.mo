model DosSeparadorsParaleloDesarroloV49_21
  ...
  parameter Real SP_petroleo = 63;

  // Controladores PI ajustados
  Modelica.Blocks.Continuous.PI pidSep1General(k=1.5, T=600);
  Modelica.Blocks.Continuous.PI pidSep1Petroleo(k=1.5, T=700);
  Modelica.Blocks.Continuous.PI pidSep2General(k=1.5, T=600);
  Modelica.Blocks.Continuous.PI pidSep2Petroleo(k=1.5, T=700);
...
end DosSeparadorsParaleloDesarroloV49_21;

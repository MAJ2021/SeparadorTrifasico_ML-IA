model DosSeparadorsParaleloDesarroloV50_0_1
  ...
  // Controladores PID (ajustados para convergencia <1800s)
  Modelica.Blocks.Continuous.PID pidSep1General(
    k=1.5, Ti=90, Td=15, y_start=0);
  Modelica.Blocks.Continuous.PID pidSep1Petroleo(
    k=4.0, Ti=20, Td=8, y_start=0);
  ...
  parameter Real gamma = 0.08;   // refuerzo cuadrático para petróleo
...
end DosSeparadorsParaleloDesarroloV50_0_1;

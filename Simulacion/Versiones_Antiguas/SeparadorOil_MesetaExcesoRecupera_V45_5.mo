model SeparadorOil_MesetaExcesoRecupera_V45_5
...
equation
  ...
  if time < 1800 then
    // Meseta inicial: entrada = salida → nivel estable
...
end SeparadorOil_MesetaExcesoRecupera_V45_5;

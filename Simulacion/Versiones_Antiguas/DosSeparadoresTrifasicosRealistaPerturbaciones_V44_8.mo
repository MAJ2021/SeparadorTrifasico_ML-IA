model DosSeparadoresTrifasicosRealistaPerturbaciones_V44_8
...
equation
  ...
  // Entrada y salida con mesetas y perturbaciones
  if time < 1800 then
...
end DosSeparadoresTrifasicosRealistaPerturbaciones_V44_8;

model DosSeparadorsParaleloDesarroloV49_23
  ...
  Modelica.Blocks.Continuous.PI pidSep1General(k=2.5, T=500);
  Modelica.Blocks.Continuous.PI pidSep1Petroleo(k=2.0, T=500);
  Modelica.Blocks.Continuous.PI pidSep2General(k=2.5, T=500);
  Modelica.Blocks.Continuous.PI pidSep2Petroleo(k=2.0, T=500);
...
end DosSeparadorsParaleloDesarroloV49_23;

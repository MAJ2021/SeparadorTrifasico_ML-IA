model DosSeparadorsParaleloDesarroloV50_0_4
  ...
  Modelica.Blocks.Continuous.PID pidSep1General(
    k=2.0, Ti=50, Td=10, y_start=0);
  Modelica.Blocks.Continuous.PID pidSep1Petroleo(
    k=3.0, Ti=30, Td=5, y_start=0);
  ...
  parameter Real beta = 0.6;   // refuerzo proporcional moderado
  parameter Real gamma = 0.02; // refuerzo cuadrático reducido para petróleo
...
end DosSeparadorsParaleloDesarroloV50_0_4;

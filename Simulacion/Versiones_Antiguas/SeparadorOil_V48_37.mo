model SeparadorOil_V48_37
  ...
  parameter Real Kp = 0.02;                   // proporcional más agresivo
  parameter Real Ki = 2e-4;                   // integral más rápido
